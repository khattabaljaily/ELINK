    ...
    banner.innerHTML = type === 'ios' ?
      '<div class="pwa-install-banner__content">' +
        ...
        '<div class="pwa-install-banner__text">' +
          '<div class="pwa-install-banner__title">Install E LINK</div>' +
          '<div class="pwa-install-banner__description">Tap ' + shareIcon + ' then "Add to Home Screen"</div>' +
        '</div>' +
        '<button type="button" class="pwa-install-banner__close" aria-label="Close">' + closeIcon + '</button>' +
      '</div>' :
      '<div class="pwa-install-banner__content">' +
        '<div class="pwa-install-banner__icon">' + downloadIcon + '</div>' +
        '<div class="pwa-install-banner__text">' +
          '<div class="pwa-install-banner__title">Install E LINK</div>' +
          '<div class="pwa-install-banner__description">Install the app on your device for quick access</div>' +
        '</div>' +
        '<div class="pwa-install-banner__actions">' +
          '<button type="button" class="pwa-install-banner__btn pwa-install-banner__btn--primary" data-action="install">Install</button>' +
          '<button type="button" class="pwa-install-banner__btn pwa-install-banner__btn--secondary" data-action="dismiss">Dismiss</button>' +
        '</div>' +
      '</div>';
